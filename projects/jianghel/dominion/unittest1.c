...
int main(){
    ...
    int r = mineAction(currentPlayer, choice1, choice2, &g, handPos);
    if(r == -1)
    {
    ...
    r = mineAction(currentPlayer, choice1, choice2, &g, handPos);
    if(r == -1)
    {
    ...
    mineAction(currentPlayer, choice1, choice2, &g, handPos);
